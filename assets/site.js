...
const CHATBOT_FAQ = [
  ...
  { topic:'تفاصيل مسار ربع وربع ونصف القرآن', kw:['ربع القران','نصف القران','كام جزء'],
    a:'ربع القرآن (٧.٥ أجزاء) مدته المتوقعة سنة إلى سنة وربع تقريباً، ونصف القرآن (١٥ جزءاً) مدته سنة ونصف إلى سنتين تقريباً — بمعدل صفحة إلى صفحتين يومياً حسب النظام.' },
  { topic:'تفاصيل مسار القرآن كامل', kw:['القران كامل','احفظ القران كله','مسار القران كامل','٣٠ جزء'],
    a:'مسار القرآن كاملاً (٣٠ جزءاً) هو الغاية الكبرى، ومدته المتوقعة سنتان إلى ثلاث سنوات بمعدل صفحتين حفظاً جديداً يومياً تقريباً.' },
