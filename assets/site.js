...
const CHATBOT_FAQ = [
  ...
  { topic:'تفاصيل مسار جزء عم وتبارك', kw:['جزء عم وتبارك','مسار عم وتبارك','ابدأ بجزء عم'],
    extra:['عم','تبارك'],
    a:'مسار جزء عمّ وتبارك مخصّص للمبتدئين ومن ليس لديه حفظ سابق، مدته المتوقعة ٤-٥ أشهر بمعدل نصف صفحة حفظاً جديداً يومياً، ومتاح في نظام رسوخ والنظام المرن.' },
  { topic:'تفاصيل مسار الزهراوان', kw:['الزهراوان','سورة البقرة وال عمران','حفظ البقرة'],
    extra:['البقره','عمران'],
    a:'مسار الزهراوان لحفظ سورتي البقرة وآل عمران، ومدته المتوقعة ١٠-١٢ شهراً — وهما السورتان اللتان تأتيان يوم القيامة تحاجّان عن صاحبهما.' },
  { topic:'تفاصيل مسار المفصل', kw:['المفصل','من سورة ق','مسار المفصل'],
    a:'مسار المفصّل يشمل من سورة ق إلى الناس، ومدته المتوقعة من ٦ إلى ٨ أشهر — وهو القسم الأكثر تلاوةً في الصلوات.' },
  { topic:'تفاصيل مسار ربع وربع ونصف القرآن', kw:['ربع القران','نصف القران','كام جزء'],
    a:'ربع القرآن (٧.٥ أجزاء) مدته المتوقعة سنة إلى سنة ونصف تقريباً، ونصف القرآن (١٥ جزءاً) مدته سنة ونصف إلى سنتين تقريباً — بمعدل صفحة إلى صفحتين يومياً حسب النظام.' },
  { topic:'تفاصيل مسار القرآن كامل', kw:['القران كامل','احفظ القران كله','مسار القران كامل','٣٠ جزء'],
    a:'مسار القرآن كاملاً (٣٠ جزءاً) هو الغاية الكبرى، ومدته المتوقعة سنتان إلى سنتين ونصف تقريباً بمعدل صفحتين حفظاً جديداً يومياً تقريباً.' },
...
/* ============================================================
   ...
   وأي دولة تانية بالدولار (رقم صحيح من غير كسور).
   ملحوظة: أسعار الصرف تقريبية وثابتة في الكود، لازم تُحدَّث
