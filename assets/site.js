...
const CHATBOT_FAQ = [
  ...
  { topic:'تفاصيل مسار المفصل', kw:['المفصل','من سورة ق','مسار المفصل'],
    a:'مسار المفصّل يشمل من سورة ق إلى الناس، ومدته المتوقعة من سنة إلى سنة ونصف — وهو القسم الأكثر تلاوةً في الصلوات.' },
  { topic:'تفاصيل مسار ربع وربع ونصف القرآن', kw:['ربع القران','نصف القران','كام جزء'],
    a:'ربع القرآن (٧.٥ أجزاء) مدته المتوقعة ٨-١٠ أشهر، ونصف القرآن (١٥ جزءاً) مدته سنة ونصف إلى سنتين تقريباً — بمعدل صفحة إلى صفحتين يومياً حسب النظام.' },
